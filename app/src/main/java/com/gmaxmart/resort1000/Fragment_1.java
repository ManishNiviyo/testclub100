...
public class Fragment_1 extends Fragment implements PaymentResultWithDataListener {
    View view;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if(response.getString("status").equals("true")){
                        ...
                        if (jsonArraycollection.length()>1){


                        //for (int i=0;i<jsonArraycollection.length();i++) {
                            JSONObject jsonObject1 = new JSONObject();
                            jsonObject1 = jsonArraycollection.getJSONObject(1);
