...
public class contactus extends AppCompatActivity {
    ...
    TextView email,website,phone,whatsapp,placename,adress;
    CardView viewbutton;
    WebView googlemap;
    String url="";
    Dialog loading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whatsapp = findViewById(R.id.whtsappnumber);
        placename = findViewById(R.id.textView12);
        adress = findViewById(R.id.textView13);
        ...
        String URL =profilecontainer.baseUrl+"/resort/api/contact_us.php";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    if(response.getString("status").equals("true")){
                        ...
                        jsonObject=response.getJSONObject("contact_us");
                        String ifram=jsonObject.getString("ifrem_link");
                        url=jsonObject.getString("map_link");
                        String ifrma="<iframe src=\""+ifram+"\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>";
                        googlemap.loadData(ifrma, "text/html", "utf-8");

                        email.setText(jsonObject.getString("email")); website.setText(jsonObject.getString("website"));
                        phone.setText("+91-"+jsonObject.getString("mobile_no")); whatsapp.setText("+91-"+jsonObject.getString("whatsapp_no"));
                        placename.setText(jsonObject.getString("place_name")); adress.setText(jsonObject.getString("address"));
                    }
                }catch (Exception e){
